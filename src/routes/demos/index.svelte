<h2 class="title">Create a Kiosk Instance</h2>
<article class="message is-info is-medium">
  ...
  <div class="message-body content ">
    <p class="is-italic">
      ...
      This means users can now request support from a device to be connected to an agent in desired orderly manner. No authentication
